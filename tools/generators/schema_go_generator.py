...
class GoCodeGenerator:
    ...
    def _process_schema_file(self, yaml_file: Path):
        ...
        go_content.append("")
        go_content.append("package mmodel")
        go_content.append("")
    ...
    def _generate_main_package_file(self):
        ...
        content.append("// ParseJSONReader 从Reader解析JSON格式的MModel对象")
        ...
        content.append("// ParseYAMLReader 从Reader解析YAML格式的MModel对象")
