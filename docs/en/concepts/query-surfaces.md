...
Query Service is the public read surface for MModel. REST, CLI, Web UI, SDKs, and MCP tools all converge on the same query concepts.
...
|---|---|---|
| `.mmodel` | Model definitions | `.mmodel with(kind='entity_set')` |
