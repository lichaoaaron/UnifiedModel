...
_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "when_to_use": "在 Trace 分析后执行。用于将观测数据字段标准化绑定到本体实体，为后续图分析和影响面推导提供基础。",
        "input_schema": {
    ...
    },
    {
        ...
        "dependencies": ["alert_context", "trace", "entity_binding"],
    ...
    },
    {
        ...
        "evidence_fields": ["affected_services", "affected_apis", "affected_business"],
    },
]
