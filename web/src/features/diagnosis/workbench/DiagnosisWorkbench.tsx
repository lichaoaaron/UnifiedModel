        ...
        <div className="px-5 py-2.5 border-t border-[#e5e7eb] bg-white flex-shrink-0">
          ...
          <div className="max-w-7xl mx-auto flex items-end gap-2 bg-[#f9fafb] rounded-lg px-3 py-2 border border-[#d1d5db] shadow-[0_1px_8px_rgba(15,23,42,0.08)]">
            ...
            {currentRunLoading ? (
              <button
                onClick={handleStop}
                className="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full border-none bg-[#1e1e1e] text-white hover:bg-[#333] transition-colors"
                title="停止"
              >
                <StopCircle size={15} />
              </button>
              ...
              <button
                ...
                className="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full border-none bg-[#1e1e1e] text-white hover:bg-[#333] disabled:bg-[#d1d5db] disabled:text-white transition-colors"
                title="发送 (Enter)"
              >
                <ArrowUp size={16} />
              </button>
