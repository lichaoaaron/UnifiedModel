...
// Diagnosis SSE goes through the plugin Go backend, which streams /diagnosis/*
// to the separate diagnosis service (jsonData.diagnosisUrl). Native fetch +
// getReader is kept (getBackendSrv cannot stream); same-origin + Grafana session.
